...
public class SpaceManagement {
    ...
    public WebElement extendbutton() throws Exception{
        ...
        element = driver.findElement(getElementUtil.getLocator("paas.spacemanagement.extendbutton"));
        return element;
    }
    ...
    public WebElement newcpufloat() throws Exception{
        //调用ObjectMap中的getLocator方法获取配置文件中关于用户名的定位方式和定位表达式
        element = driver.findElement(getElementUtil.getLocator("paas.newspace.cpufloat"));
        return element;
    }
    ...
    public WebElement newmemfloat() throws Exception{
        //调用ObjectMap中的getLocator方法获取配置文件中关于用户名的定位方式和定位表达式
        element = driver.findElement(getElementUtil.getLocator("paas.newspace.memfloat"));
        return element;
    }
    //返回空间管理页面-新增空间窗口中“保存”按钮页面元素对象
    public WebElement newsavebutton() throws Exception{
        //调用ObjectMap中的getLocator方法获取配置文件中关于用户名的定位方式和定位表达式
        element = driver.findElement(getElementUtil.getLocator("paas.newspace.savebutton"));
        return element;
    }
    ...
    public WebElement newXbutton() throws Exception{
        //调用ObjectMap中的getLocator方法获取配置文件中关于用户名的定位方式和定位表达式
        element = driver.findElement(getElementUtil.getLocator("paas.newspace.Xbutton"));
        return element;
    }
    //返回空间管理页面-空间扩容窗口中“租户空间”下拉框页面元素对象
    public WebElement space() throws Exception{
        //调用ObjectMap中的getLocator方法获取配置文件中关于用户名的定位方式和定位表达式
        element = driver.findElement(getElementUtil.getLocator("paas.excendspace.space"));
        return element;
    }
    ...
    public WebElement cpufloat() throws Exception{
        //调用ObjectMap中的getLocator方法获取配置文件中关于用户名的定位方式和定位表达式
        element = driver.findElement(getElementUtil.getLocator("paas.excendspace.cpufloat"));
        return element;
    }
    ...
    public WebElement memfloat() throws Exception{
        //调用ObjectMap中的getLocator方法获取配置文件中关于用户名的定位方式和定位表达式
        element = driver.findElement(getElementUtil.getLocator("paas.excendspace.memfloat"));
        return element;
    }
    //返回空间管理页面-空间扩容窗口中“保存”按钮页面元素对象
    public WebElement savebutton() throws Exception{
        //调用ObjectMap中的getLocator方法获取配置文件中关于用户名的定位方式和定位表达式
        element = driver.findElement(getElementUtil.getLocator("paas.excendspace.savebutton"));
        return element;
    }
    ...
    public WebElement Xbutton() throws Exception{
        //调用ObjectMap中的getLocator方法获取配置文件中关于用户名的定位方式和定位表达式
        element = driver.findElement(getElementUtil.getLocator("paas.excendspace.Xbutton"));
        return element;
    }
