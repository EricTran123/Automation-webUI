...
public class MongoDBUtil {
    ...
    public static void connectMongoDB()throws Exception{
        try{
            // 连接到 mongodb 服务
    ...
    public static void insertCollection()throws Exception{
        try{
            // 连接到 mongodb 服务
            MongoClient mongoClient = new MongoClient( "localhost" , 27017 );
    ...
    public static void getCollection()throws Exception{
        try{
            // 连接到 mongodb 服务
            MongoClient mongoClient = new MongoClient( "localhost" , 27017 );
